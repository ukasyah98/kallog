                ...
                <div key={`filter-${f.name}`}>
                  ...
                  <Box display="flex" >
                    <TextField
                      ...
                      onChange={(e) => onChange(f.name, [parseInt(e.target.value), formData[f.name][1]])}
                    ...
                    <TextField
                      ...
                      margin="dense"
                      style={{ flex: 1 }}
                      onChange={(e) => onChange(f.name, [formData[f.name][0], parseInt(e.target.value)])}
